...
В случае, если во вливаемой ветке была не добавлена, а именно изменена информация ранее зафиксированная в принимающей ветке, возникает merge conflict (конфликт слияния). В этом случае терминал выводит окна в которых видны оба варианта и выделены участки кода, котрые конфликтуют между собой. В этом случае, пользователь принимает решение, принять или не принять изменения.
