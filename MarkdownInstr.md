...
В текст можно [<span style="color:red"> вставлять][1] [<span style="color:green">несколько][2] [<span style="color:magenta">ссылок][3] указывая их, как сноски. Или как [короткий вариант][]
...
Можно изменять цвет текста. Для этого нужно написать (<span style="color:???">) и после color: указаать название желаемого текста.
Например
